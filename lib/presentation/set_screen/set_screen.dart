...
class SetScreen extends StatelessWidget {
        ...
        child: Scaffold(
            ...
            body: SizedBox(
                ...
                child: Column(children: [
                  Spacer(),
                  CustomImageView(
                      imagePath: ImageConstant.imgSet11,
                      height: 128.v,
                      width: 300.h),
        ...
        child: Column(
            ...
            children: [
              Padding(
                  ...
                  child:
                      Text("TABLE SET", style: theme.textTheme.headlineLarge)),
              ...
              Container(
                  ...
                  child: Text(
                      "The 3D model of the table and chair set by ABC Furniture showcases modern design and realistic textures, providing interior designers and architects with a versatile asset for creating stylish dining or office scenes in their visualizations or virtual renderings.",
                      maxLines: 7,
  ...
  /// Navigates to the setcamScreen when the action is triggered.
  onTapOpenInCamera(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.setcamScreen);
  }
}
